...
interface AppState {
  ...
  // Screening Room publish persistence
  instagramPublishStatus: "idle" | "uploading" | "success" | "error"
  setInstagramPublishStatus: (status: "idle" | "uploading" | "success" | "error") => void
  instagramPublishUrl: string | null
  setInstagramPublishUrl: (url: string | null) => void
  instagramPublishError: string | null
  setInstagramPublishError: (error: string | null) => void
  // Reset
  resetSession: () => void
}
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const [instagramPublishStatus, setInstagramPublishStatus] = useState<"idle" | "uploading" | "success" | "error">("idle")
  const [instagramPublishUrl, setInstagramPublishUrl] = useState<string | null>(null)
  const [instagramPublishError, setInstagramPublishError] = useState<string | null>(null)
