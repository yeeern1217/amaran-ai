                  ...
                  <CardContent className="px-4 pb-4">
                    <div className="flex flex-wrap gap-2">
                      {recommendedCharacters.map((role) => {
                        const lower = role.toLowerCase()
                        const isFake = lower.includes("fake") || lower.includes("scam")
                        const isPersonRole = !isFake && (lower.includes("victim") || lower.includes("retiree") || lower.includes("narrator") || lower.includes("officer") || lower.includes("inspektor") || lower.includes("inspector") || lower.includes("law enforcement") || lower.includes("police") || lower.includes("parent") || lower.includes("elderly") || lower.includes("teacher") || lower.includes("student"))
                        const isScammer = isFake || !isPersonRole
                        return (
                          <Badge
                            key={role}
                            variant="outline"
